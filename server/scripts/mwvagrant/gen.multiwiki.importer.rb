...
wikis.each do |s|
   ...
   puts <<EOF
echo "------------- #{s} --------------"
curl 'https://dumps.wikimedia.org/other/testfiles/20160405/#{s}_20160405_testsamples.xml.bz2' -o - | bunzip2 > ../#{s}.dump.xml
...
rm ../#{s}.dump.xml
mwscript maintenance/rebuildrecentchanges.php --wiki #{dbname}
